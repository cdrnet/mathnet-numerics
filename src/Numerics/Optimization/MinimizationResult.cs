...
namespace MathNet.Numerics.Optimization
{
    public class MinimizationResult
    {
        ...
        public IObjectiveVectorFunction FunctionInfoAtMinimum { get; private set; }
        public int Iterations { get; private set; }
        public ExitCondition ReasonForExit { get; private set; }

        public MinimizationResult(IObjectiveVectorFunction functionInfo, int iterations, ExitCondition reasonForExit)
        {
