...
namespace MathNet.Numerics.Optimization
{
    ...
    {
        public IObjectiveVectorFunction ObjectiveFunction { get; private set; }

        public EvaluationException(string message, IObjectiveVectorFunction eval)
            : base(message)
        {
            ObjectiveFunction = eval;
        }

        public EvaluationException(string message, IObjectiveVectorFunction eval, Exception innerException)
            : base(message, innerException)
        {
            ObjectiveFunction = eval;
        }
