...
{
    public static class ObjectiveVectorFunction
    {
        /// <summary>
        /// Objective function where neither Gradient nor Hessian is available.
        /// </summary>
        public static IObjectiveVectorFunction Value(Func<Vector<double>, double> function)
        {
        ...
        /// </summary>
        public static IObjectiveVectorFunction Gradient(Func<Vector<double>, Tuple<double, Vector<double>>> function)
        {
        ...
        /// </summary>
        public static IObjectiveVectorFunction Gradient(Func<Vector<double>, double> function, Func<Vector<double>, Vector<double>> gradient)
        {
        ...
        /// </summary>
        public static IObjectiveVectorFunction Hessian(Func<Vector<double>, Tuple<double, Matrix<double>>> function)
        {
        ...
        /// </summary>
        public static IObjectiveVectorFunction Hessian(Func<Vector<double>, double> function, Func<Vector<double>, Matrix<double>> hessian)
        {
        ...
        /// </summary>
        public static IObjectiveVectorFunction GradientHessian(Func<Vector<double>, Tuple<double, Vector<double>, Matrix<double>>> function)
        {
        ...
        /// </summary>
        public static IObjectiveVectorFunction GradientHessian(Func<Vector<double>, double> function, Func<Vector<double>, Vector<double>> gradient, Func<Vector<double>, Matrix<double>> hessian)
        {
